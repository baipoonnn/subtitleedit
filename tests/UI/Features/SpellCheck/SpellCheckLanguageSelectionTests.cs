...
public class SpellCheckLanguageSelectionTests : IDisposable
{
    ...
    private sealed class NullThaiSpellDownloadService : IThaiSpellDownloadService
    {
        ...
        public Task DownloadOnnxRuntimeAsync(IProgress<float>? progress, CancellationToken cancellationToken)
        {
            return Task.CompletedTask;
        }
    }
    ...
    private static SpellCheckViewModel MakeViewModel()
    {
        return new SpellCheckViewModel(
            ...
            new NullThaiSpellDownloadService());
    }
